...
```bash
GET xxx.com/api/v1/books?page=1

GET xxx.com/api/v1/books?page=1&size=10
```
...
```bash
https://github.com/xxx?after=Y3Vyc29yOnYyOpK5MjAyMC0wOC0wN1QxNzo1OTowOSswODowMM4N3Lew&tab=stars
```
