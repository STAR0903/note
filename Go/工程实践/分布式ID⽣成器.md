...
[github.com/bwmarrin/snowflake](https://github.com/bwmarrin/snowflake)是⼀个相当轻量化的snowflake的Go实现。
...
var (
	InvalidInitParamError = errors.New("snowflake初始化失败，无效的startTime或者machineID")
...
func Init(startTime string, machineID int64) (err error) {
	if machineID <= 0 || len(startTime) == 0 {
		return InvalidInitParamError
	}
	var st time.Time
